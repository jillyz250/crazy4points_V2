    ...
    defineField({
      ...
      options: {
        list: [
          ...
          { title: 'Choice Privileges', value: 'choice' },
          // Credit card currencies
          { title: 'Bilt Rewards', value: 'bilt' },
          { title: 'Wells Fargo Rewards', value: 'wells_fargo' },
          { title: 'US Bank Altitude', value: 'us_bank' },
          // Airlines
          { title: 'Alaska Airlines Mileage Plan', value: 'alaska' },
          { title: 'British Airways Executive Club', value: 'british_airways' },
          { title: 'Air Canada Aeroplan', value: 'aeroplan' },
          { title: 'Singapore Airlines KrisFlyer', value: 'krisflyer' },
          { title: 'Cathay Pacific Asia Miles', value: 'asia_miles' },
          { title: 'Emirates Skywards', value: 'emirates' },
          { title: 'Etihad Guest', value: 'etihad' },
          { title: 'Japan Airlines JAL Mileage Bank', value: 'jal' },
          { title: 'Turkish Airlines Miles&Smiles', value: 'turkish' },
          { title: 'Aeromexico Club Premier', value: 'aeromexico' },
          { title: 'EVA Air Infinity MileageLands', value: 'eva_air' },
          { title: 'JetBlue TrueBlue', value: 'jetblue' },
          { title: 'Qatar Airways Privilege Club', value: 'qatar' },
          // Hotels
          { title: 'Wyndham Rewards', value: 'wyndham' },
          { title: 'Radisson Rewards', value: 'radisson' },
          { title: 'Best Western Rewards', value: 'best_western' },
          { title: 'Accor Live Limitless', value: 'accor' },
        ],
      },
    }),
