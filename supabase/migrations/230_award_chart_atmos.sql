-- 230_award_chart_atmos.sql
-- Award Chart Rebuild Phase 2 batch 1 — Atmos Rewards (Alaska + Hawaiian).
--
-- Inserts the structured chart for slug='atmos'. Each partner gets its
-- own `distance` chart object (different bands per partner per the
-- preserved Alaska MileagePlan model). 11 chart objects total.
--
-- Confidence: HIGH on Cathay / JAL / Qantas / Fiji / Etihad (well-known
-- sweet spots); MED on BA / Iberia / Korean / smaller partners.
--
-- Authored: 2026-05-11
