...
export const PUZZLE_ROTATION: Omit<Puzzle, 'date'>[] = [
  ...
  },
  {
    ...
    difficulty: 'medium',
    story:
      "Tuesday morning. Eight coworkers heading to the offsite. Drew (the CEO) booked first class for herself and Priya (the CFO). Everyone else is in coach.",
    clues: [
      "Drew and Priya are both flying first class — they're the execs, nothing less.",
      "The three engineers (Nora, Ben, Carlos) are reviewing a pitch deck mid-flight — they need three contiguous seats, same row.",
      "Ash is 6'4\" with bad knees — he wants the exit row AND an aisle.",
      "Theo is the intern. He refuses to sit in a middle seat. Refuses.",
      "Maya is flying with a bassinet baby — front row of economy is the only place it attaches.",
    ],
    layout: NARROWBODY_LAYOUT,
    passengers: [
      { id: 'p1', name: 'Drew', avatar: '🤵', avatarSeed: 'drew-ceo-exec', chips: [{ type: 'class_required', cabin: 'first' }] },
      { id: 'p2', name: 'Priya', avatar: '👔', avatarSeed: 'priya-cfo', chips: [{ type: 'class_required', cabin: 'first' }] },
      { id: 'p3', name: 'Nora', avatar: '👩‍💻', avatarSeed: 'nora-engineer', chips: [{ type: 'adjacency', group: 'eng' }] },
      { id: 'p4', name: 'Ben', avatar: '👨‍💻', avatarSeed: 'ben-engineer', chips: [{ type: 'adjacency', group: 'eng' }] },
      { id: 'p5', name: 'Carlos', avatar: '🧑‍💻', avatarSeed: 'carlos-engineer', chips: [{ type: 'adjacency', group: 'eng' }] },
      {
        id: 'p6',
        name: 'Ash',
        avatar: '🧑‍🎓',
      ...
      { id: 'p7', name: 'Theo', avatar: '🧑', avatarSeed: 'theo-intern', chips: [{ type: 'no_middle' }] },
  ...
  },
  {
    ...
    difficulty: 'medium',
    story:
      "Family reunion flight to Phoenix. Eleanor upgraded herself. Everyone else is figuring it out at the gate.",
    clues: [
      "Eleanor upgraded with miles — she's in first class.",
      "Joe and May are a couple. They need to sit next to each other.",
      ...
      "Tess has a long-haul layover after this — she wants an aisle so she can stretch.",
      "Bea has the bassinet baby — front row of economy is the only place it attaches.",
    ],
    layout: NARROWBODY_LAYOUT,
    passengers: [
      { id: 'p1', name: 'Eleanor', avatar: '👵', avatarSeed: 'eleanor-grandma', chips: [{ type: 'class_required', cabin: 'first' }] },
      { id: 'p2', name: 'Joe', avatar: '👴', avatarSeed: 'joe-uncle', chips: [{ type: 'couple', with: 'p3' }] },
      { id: 'p3', name: 'May', avatar: '👩', avatarSeed: 'may-aunt', chips: [{ type: 'couple', with: 'p2' }] },
      ...
      { id: 'p7', name: 'Tess', avatar: '👩‍🦱', avatarSeed: 'tess-sister', chips: [{ type: 'aisle_required' }] },
