...
export const PLATFORM_TRACK: PlatformItem[] = [
  ...
  { title: 'Per-card companion guides', detail: 'a standalone "How to Get the Most from [Card]" guide for each of the ~108 active credit cards, cross-linked from the card page — welcome-offer strategy, best use of credits, the benefit stack (CardBenefitStacks), who it is for, and card pairings. Built from existing verified card data. Cadence 1/day (like the airline changes/cancel backfill). Jill request 2026-08-28.', status: 'next' },
