/**
 * Custom 404 for the public site.
 *
 * Lives inside the (site) route group so it inherits Header + Footer
 * automatically. Any unmatched URL under crazy4points.com will render this
 * page with full site chrome.
 *
 * Returns HTTP 404 (Next.js handles status code automatically for not-found.tsx)
 * — this is intentional and correct for SEO. Don't redirect unknown URLs to
 * the homepage; that's a "soft 404" that Google penalizes.
 */
