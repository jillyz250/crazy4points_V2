...
/** Live count of open program-fact drift conflicts — for the hub tab badge. */
export async function programDriftCount(): Promise<number> {
...
/**
 * Program-fact drift panel — the body of the old /admin/program-drift page,
 * relocated verbatim to render inside the Accuracy hub.
 */
export default async function ProgramDriftPanel() {
  const supabase = createAdminClient()
