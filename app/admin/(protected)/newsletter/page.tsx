...
export default async function NewsletterAdminPage({
  ...
  const { data: rowsData } = await supabase
    .from('newsletters')
    .select(
      'id, week_of, subject, subject_options, status, sent_at, display_date, recipient_count, created_at, hero_kicker, jill_prompt, big_story_ref_type, big_story_ref_id, big_story_title, big_story_html, big_story_claims, big_story_missing_facts, sweet_spot_ref_type, sweet_spot_ref_id, sweet_spot, top_experiences, also_happening, active_offers, elevated_bonuses, jills_take_html, game_slug, game_title, game_clue_text',
    )
