...
/** Live count of open card welcome-bonus signals — for the hub tab badge. */
export async function cardBonusSignalsCount(): Promise<number> {
...
/**
 * Welcome-bonus signals panel — the body of the old /admin/card-bonus-signals
 * page, relocated verbatim to render inside the Accuracy hub.
 */
export default async function CardBonusSignalsPanel() {
  const supabase = createAdminClient()
