...
6. **Legacy / discontinued co-brand cards presented alongside actively-issued cards as if equivalent.** When the content lists co-brand card caps, FNAs, anniversary perks, or card-specific benefits, every card named must either (a) be currently issuable to new applicants, or (b) be explicitly labeled as legacy / discontinued / no longer issued. If a card is named without that label and you have any reason to believe it is no longer issued (Marriott Bonvoy basic Chase, Marriott Bonvoy Premier Chase, Ritz-Carlton Chase, Citi Prestige, Chase Sapphire Reserve Business pre-2024, etc. — use 2026 knowledge), flag it. The fix is to either reframe the listing as "active spread" + "legacy cards" sections, or remove the legacy reference entirely.
7. **Transitional phrases that don't match the relationship between the ideas they connect.** When a sentence uses "flip side", "on the other hand", "however", "in contrast", "the trade-off", "but", or similar opposition/contrast words, verify the two ideas being connected are actually opposites or in tension. "Flip side of having a huge portfolio: dynamic pricing" is wrong — dynamic pricing isn't the opposite of having a huge portfolio; they're related but not opposed. Flag any "flip side / opposite / however / on the other hand" that connects ideas with no real opposition. The fix is a transition word that matches the actual relationship ("trade-off for", "consequence of", "alongside that", "and", or just splitting into two sentences).
